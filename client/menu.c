...
{
{"+attack", 		"attack"},
//{"+use", 			"activate"},	// Knightmare added
{"weapprev", 		"prev weapon"},	// Knightmare added
...
static menuaction_s		s_keys_prev_weapon_action;	// Knightmare added
...
static void Keys_MenuInit( void )
{
	...
	// Knightmare- added binds
/*	s_keys_use_action.generic.type	= MTYPE_ACTION;
	s_keys_use_action.generic.flags  = QMF_GRAYED;
	s_keys_use_action.generic.x		= 0;
	s_keys_use_action.generic.y		= y += 9;
...
//	Menu_AddItem( &s_keys_menu, ( void * ) &s_keys_use_action );	// Knightmare added
	Menu_AddItem( &s_keys_menu, ( void * ) &s_keys_prev_weapon_action );	// Knightmare added
...
//	strcpy( currentdirectory, skin->string );
	...
	if (viddef.height >= 300)		// player model will draw out of bounds on very low res
